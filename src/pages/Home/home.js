               ...
               <div className=" flex flex-col w-10/12 h-full">
                       <div className=" flex flex-row">
                            <div className="w-2/3 p-5">
                                <div className="w-full bg-white h-60   border rounded ">
                                   <div> <h1 className="text-2xl text-sv-text-2 font-bold shadow-sm ml-2  h-10">Thông tin sinh viên</h1></div>
                       ...
                       <div className="flex h-full">
                           ...
                           <div className="">
                                ...
                                <ItemMenu Icon={<FaCalendarAlt color="#47A9FF" size={30}/>} NameMenu='Lịch theo tuần' onClick={()=>alert('tuan')} ></ItemMenu>
                                <ItemMenu Icon={<FaRegChartBar color="#47A9FF" size={30}/>} NameMenu='Kết quả học tập ' onClick={()=>alert('thang')}></ItemMenu>
                                <ItemMenu Icon={<FaBuffer color="#47A9FF" size={30}/>} NameMenu='Đăng ký học phần ' onClick={()=>alert('thang')}></ItemMenu>
                                <ItemMenu Icon={<FaList color="#47A9FF" size={30}/>} NameMenu='Lịch theo tiến độ ' onClick={()=>alert('thang')}></ItemMenu>
                           ...
                           <div className="flex h-80 mt-3">
                                <div className="w-8/12 pr-3">
                                    <div className="h-full  p-2 flex bg-white d border  rounded ">
                                        ...
                                        <div className="flex justify-between items-center  h-10  border-b-2">
                                            <div> <h1 className="text-xl flex text-sv-text-2 font-bold  ">Kết quả học tập</h1></div>
                                            <div className="flex items-center border  border-sv-blue-4 rounded">
                                            <select className="text-sv-text-2 border  border-sv-blue-4 " value={selectedOption} onChange={handleChange}>
                                                {options.map(option => (
                                ...
                                <div className="h-full  p-2 flex bg-white d border  rounded ">
                                        <div className="w-full ml-3 mr-3">
                                        <div className="flex justify-between items-center  h-10  border-b-2">
                                            <div> <h1 className="text-xl flex text-sv-text-2 font-bold  ">Tiến độ học tập</h1></div>
                           ...
                           <div className="w-1/3">
                                <div className="flex h-full bg-white d border border-white rounded">
                                    <div className="w-full ml-3 mr-3">
                                        <div className="flex justify-between items-center  h-10  border-b-2">
                                            <div> <h1 className="text-xl flex text-sv-text-2 font-bold  ">Lớp học phần</h1></div>
                                            <div className="flex items-center border  border-sv-blue-4 rounded">
                                            <select className="text-sv-text-2 border  border-sv-blue-4 " value={selectedOption} onChange={handleChange}>
                                                {options.map(option => (
                                                 <option key={option} value={option}>
